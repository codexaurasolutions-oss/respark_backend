...
async function main() {
  ...
  const staffList = [
    { name: "Rahul Sharma", email: "rahul.sharma@skillify.local", phone: "+919876543201", salonRole: "STAFF", customRoleId: createdRoles["Senior Stylist"].id, branchId: mainBranch.id, designation: "Senior Stylist", perms: staffPermissions },
    { name: "Priya Kapoor", email: "priya.kapoor@skillify.local", phone: "+919876543202", salonRole: "RECEPTIONIST", customRoleId: createdRoles["Receptionist Manager"].id, branchId: mainBranch.id, designation: "Receptionist Manager", perms: receptionistPermissions },
    { name: "Amit Verma", email: "amit.verma@skillify.local", phone: "+919876543203", salonRole: "MANAGER", customRoleId: null, branchId: mainBranch.id, designation: "Salon Manager", perms: managerPermissions },
    { name: "Sneha Iyer", email: "sneha.iyer@skillify.local", phone: "+919876543204", salonRole: "STAFF", customRoleId: createdRoles["Skin Care Specialist"].id, branchId: dhaBranch.id, designation: "Skin Care Specialist", perms: staffPermissions },
    { name: "Vikram Rajput", email: "vikram.rajput@skillify.local", phone: "+919876543205", salonRole: "STAFF", customRoleId: createdRoles["Senior Stylist"].id, branchId: gulbergBranch.id, designation: "Senior Barber", perms: staffPermissions },
    { name: "Neha Joshi", email: "neha.joshi@skillify.local", phone: "+919876543206", salonRole: "STAFF", customRoleId: createdRoles["Makeup Artist"].id, branchId: joharBranch.id, designation: "Makeup Artist", perms: staffPermissions },
    { name: "Arjun Nair", email: "arjun.nair@skillify.local", phone: "+919876543207", salonRole: "STAFF", customRoleId: createdRoles["Junior Stylist"].id, branchId: dhaBranch.id, designation: "Junior Stylist", perms: staffPermissions },
    { name: "Kavita Deshmukh", email: "kavita.deshmukh@skillify.local", phone: "+919876543208", salonRole: "STAFF", customRoleId: createdRoles["Skin Care Specialist"].id, branchId: joharBranch.id, designation: "Skin Care Specialist", perms: staffPermissions }
  ];
